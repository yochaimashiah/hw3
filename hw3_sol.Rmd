...
4. Build a term-Document graph that displays connections between terms that appear together in common posts.
   vertex= term.
   edge= connections between terms that appear together in common posts
...
Highest-donald, trump 1.557232e+03
```{r}
...
Highest- donald, trump 1.083424e-03
```{r}
...
Highest- donald, trump 1.00000000
```{r}
